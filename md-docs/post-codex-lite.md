...
4. 작성 파일과 category 확정
5. KO/EN 제목, 설명, keywords, 본문, FAQ, relatedPosts 작성
6. 내부 링크와 relatedPosts 실존 여부 확인
7. `npm run build` 실행
8. 완료 후 `now-posting-current.md`와 원본 `now-posting.md` 갱신

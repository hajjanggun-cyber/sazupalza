...
export const alt = '궁합 분석 | Sajupalza';
...
const COPY = {
  ko: { title: '궁합 분석', subtitle: '사주 · MBTI · 관상으로 보는 완벽한 인연 분석', badge: '궁합 · 연애 · 인연' },
  en: { title: 'Compatibility Analysis', subtitle: 'Perfect Match by Saju · MBTI · Face Reading', badge: 'Compatibility · Love · Destiny' },
} as const;
    ...
    (
      <div
        style={{
          ...
          background: 'radial-gradient(circle at 50% 20%, rgba(236,72,153,0.15), transparent 40%), linear-gradient(160deg, #0f0c29 0%, #1e1b3b 50%, #111827 100%)',
      ...
      >
        ...
        <div style={{ fontSize: 92, marginBottom: 18, lineHeight: 1 }}>❤️</div>

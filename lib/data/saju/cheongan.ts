...
export const cheonganData: Record<string, Cheongan> = {
  ...
  eul: {
    ...
    meaningEn: 'Yin Wood (陰木) - Grass & Flowers, Energy of Flexibility',
  ...
  byeong: {
    ...
    meaningEn: 'Yang Fire (丙火) - The Sun, Energy of Brightness',
  ...
  jeong: {
    ...
    meaningEn: 'Yin Fire (丁火) - Candle, Energy of Warmth',
  ...
  mu: {
    ...
    meaningEn: 'Yang Earth (戊土) - Great Mountain, Energy of Stability',
  ...
  gi: {
    ...
    meaningEn: 'Yin Earth (己土) - Farmland, Energy of Practicality',
  ...
  gyeong: {
    ...
    meaningEn: 'Yang Metal (庚金) - Raw Ore, Energy of Decisiveness',
  ...
  sin: {
    ...
    meaningEn: 'Yin Metal (辛金) - Jewel, Energy of Refinement',
  ...
  im: {
    ...
    meaningEn: 'Yang Water (壬水) - River & Ocean, Energy of Insight',
  ...
  gye: {
    ...
    meaningEn: 'Yin Water (癸水) - Dew & Spring, Energy of Sensitivity',
